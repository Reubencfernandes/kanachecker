<html>
    <head><title>katakana Chart</title>
    ...
    <header class="siteheader">  
        ...
        <?php
$json = file_get_contents("./json/katakana.json");
$json_data = json_decode($json,true);
echo "<h1 style='text-align:center;padding:10px;color:black;font-family: poppins;'>Katakana カタカナ</h1>";
